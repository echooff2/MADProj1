...
\begin{itemize}
	...
	\item {\bf diff\_PCA\_Component\_1} --- Nowa zmienna utworzona w procesie PCA. [TODO][DOPRECYZOWAĆ]
\end{itemize}

\subsection{Charakterystyka zmiennych}
\begin{table}[H]
\centering
\caption{Charakterystyka wybranych zmiennych.}
...
\midrule
	...
	redFirstBlood & Binarna & Norminalna & Skokowa \\
...
\begin{table}[H]
\centering
\caption{Statystyki opisowe wybranych zmiennych.}
\resizebox{\textwidth}{!}{
\begin{tabular}{l c c c c c c c c c c c}
\toprule
...
\begin{figure}[H]
	\centering
	\makebox[\textwidth][c]{%
		\includegraphics[width=1.0\textwidth]{../Plots/corrmatrixes/WykresZ_KA.png}
	}
	\caption{Macierz korelacji dla wybranych zmiennych.}
\end{figure}
