...
sieć neuronowa MLP = 72,82\%, drzewo klasyfikacyjne = 72,69\%, KNN = 71,49\%, model hybrydowy oparty na średniej arytmetycznej = 72,48\%
oraz model hybrydowy oparty na sieci neuronowej = 72,65\%. Najlepszy wynik uzyskała sieć neuronowa, osiągając dodatkowo wartość AUC równą 0,804.
