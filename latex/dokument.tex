...
\item implementację oraz zastosowanie metod klasyfikacji: sieci nauronowe, drzewo klasyfikacyjne, KNN oraz [TODO][NAZWA METODY HYBRYDOWEJ],
...
Zastosowana architektura składała się z:
\begin{itemize}
...
W analizie wykorzystano algorytm KNN zaimplementowany w bibliotekach \texttt{caret} oraz \texttt{class}. Dane zostały losowo podzielone na zbiór treningowy (80\% obserwacji) oraz testowy (20\% obserwacji). Model został zbudowany na zbiorze treningowym, natomiast jego skuteczność oceniono na niezależnym zbiorze testowym.
...
\subsection{Drzewo klasyfikacyjne}
	...
	\caption{Wykres krzywej ROC dla metody drzewa kalsyfikacyjnego.}
        \label{fig:both_images}
    \end{figure}
...
\subsection{K najbliższych sąsiadów}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.6\textwidth]{../Plots/roc_curves/roc_KNN.png}
	\caption{Wykres krzywej ROC dla metody KNN.}
        \label{fig:both_images}
    \end{figure}
