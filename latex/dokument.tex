...
\begin{tabular}{l c c}
	...
	\midrule
	Sieci Neuronowe & 73,31\% & 0,811 \\ 
	Drzewo Klasyfikacyjne &  72,69\% & 0,782 \\
	KNN  & 71,59\% & 0,793 \\
	hybr. - Sieć neuronowa  & 71,67\% & 0,802 \\
	hybr. Średnia & 72,96\%  & 0,808 \\
	\bottomrule
\end{tabular}
...
\begin{tabular}{l c c}
	...
	KNN  & 71,47\% & 0,789 \\
	hybr. - Sieć neuronowa  & 72,69\% & 0,805 \\
	hybr. - Średnia & 72,48\%  & 0,800 \\
	\bottomrule
\end{tabular}
...
Uprzednio przedstawione wyniki skuteczności zastosowanych metod wskazują, że udało nam się osiągnąć dokładność na poziomach odpowiednio: sieć neuronowa MLP = 73,31\%, drzewo klasyfikacyjne = 72,69\%, KNN = 71,59\%, model hybrydowy oparty na średniej arytmetycznej = 72,96\% oraz model hybrydowy oparty na sieci neuronowej = 71,67\%. Najlepszy wynik uzyskała sieć neuronowa, osiągając dodatkowo wartość AUC równą 0,811. Stanowi to dobry rezultat, potwierdzający, że dane z wczesnej fazy meczu zawierają istotną informację predykcyjną.
...
\section*{Źródło danych}
    ...
    Dostęp online: \url{https://www.kaggle.com/datasets/bobbyscience/league-of-legends-diamond-ranked-games-10-min} \\
