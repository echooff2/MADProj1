...
\section{Załączniki}
Poniżej znajduje się lista załączonych plików do projektu:
\begin{itemize}
\item \textbf{lol.csv} --- 
\item \textbf{ClassificationTree.R} --- 
\item \textbf{CorrelationWisualization.R} --- 
\item \textbf{endDatasetWisualization.R} --- 
\item \textbf{KNN.R} --- 
\item \textbf{PCA.R} --- 
\item \textbf{PreliminaryAnalisys.R} --- 
\item \textbf{ROC.R} --- 
\item \textbf{TableWisualization.R} --- 
\item \textbf{tensorflow.R} --- 
\item \textbf{} --- 
\end{itemize}
